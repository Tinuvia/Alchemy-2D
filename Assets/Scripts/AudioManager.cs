...
public class AudioManager : MonoBehaviour
{
    ...
    public AudioClip ambientClip;       //The general background ambient sound
    public AudioClip ambientForestClip;
    public AudioClip ambientCaveClip;
    ...
    public AudioClip orbStingClip;      //The sting played when the player picks up an orb
    public AudioClip doorOpenStingClip;

    [Header("Character Audio")]
    public AudioClip[] stepWalkClips;   //The footstep sound effects
    public AudioClip[] stepSoftClips;
    public AudioClip[] stepWetClips;
    public AudioClip[] stepCrouchClips;
    ...
    AudioSource ambientSource;		//Reference to a generated ambient Audio Source
    //AudioSource ambientForestSource;
    ...
    void Awake()
    {
        ...
        //ambientForestSource = gameObject.AddComponent<AudioSource>() as AudioSource;
    ...
    public static void PlayFootstepAudio()
    {
        ...
        int index = Random.Range(0, current.stepWalkClips.Length);

        //Set the footstep clip and tell the source to play
        current.playerSource.clip = current.stepWalkClips[index];
    ...
    public static void PlayCrouchFootstepAudio()
    {
        ...
        int index = Random.Range(0, current.stepCrouchClips.Length);

        //Set the footstep clip and tell the source to play
        current.playerSource.clip = current.stepCrouchClips[index];
        current.playerSource.Play();
    }
    ...
    public static void PlayJumpAudio()
    {
        ...
        current.playerSource.clip = current.jumpTakeOffClip;
        current.playerSource.Play();
    ...
    public static void PlayOrbCollectionAudio()
    {
        ...
        current.stingSource.clip = current.orbVoiceClip;
        current.stingSource.Play();
